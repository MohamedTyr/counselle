...
Status: **draft for owner approval; implementation has not started**
...
While this plan is active it stays in `plans/`. After implementation, focused
verification, live UI review, and owner acceptance, graduate the finalized plan
to `specs/counseling-response-modes/` and update the living architecture/ADR
documentation. Do not modify product code until the owner explicitly approves
this plan.
