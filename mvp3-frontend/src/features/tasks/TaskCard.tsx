  ...
  return (
    ...
    >
      <article
        ...
        className={cn(
          "group/task w-full cursor-grab rounded-xl border border-[color:var(--lane-card-border)] bg-[color:var(--lane-card)] p-3 text-left shadow-xs/5 transition-[background-color,border-color,box-shadow] outline-none hover:bg-[color:var(--lane-card-hover)] focus-visible:ring-3 focus-visible:ring-ring/50 active:cursor-grabbing",
          isDone && "bg-[color:var(--lane-card)]",
          isSelected &&
            "border-ring/55 bg-[color-mix(in_oklch,var(--lane-card),var(--foreground)_8%)] ring-2 ring-ring/30 hover:bg-[color-mix(in_oklch,var(--lane-card),var(--foreground)_11%)]",
