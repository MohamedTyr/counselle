...
export const fallbackEssay =
  essays.find((essay) => essay.id === "common-app-main") ?? essays[0]
...
export function getInitialEssayContent(essay: EssayLibraryCardData) {
  const lines =
...
export function getEssayPrompt(essay: EssayLibraryCardData) {
