...
export function EssayEditorToolbar({
  ...
  return (
    <Toolbar
      ...
      className="inline-flex w-max flex-nowrap items-center justify-start rounded-xl border border-border/80 bg-background/95 p-1 shadow-[0_1px_4px_oklch(0_0_0/0.08)] backdrop-blur supports-[backdrop-filter]:bg-background/90"
    >
      <ToolbarGroup>
        <Select
          disabled={disabled}
        ...
        >
          <SelectTrigger
            aria-label="Font"
            className="h-7 min-h-7 w-[116px] min-w-[116px] rounded-lg border-border px-2 text-xs font-medium shadow-none sm:min-h-7"
            size="sm"
          >
            <SelectValue />
          </SelectTrigger>
