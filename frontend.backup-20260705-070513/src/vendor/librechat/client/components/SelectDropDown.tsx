...
import type { Option, OptionWithIcon, DropdownValueSetter } from '@librechat/client/common';
import { useMultiSearch } from './MultiSearch';
import { CheckMark } from '@librechat/client/svgs';
  ...
  return (
    <div className={cn('flex items-center justify-center gap-2', containerClassName ?? '')}>
      <div className={cn('relative w-full', subContainerClassName ?? '')}>
        <Listbox value={value as string | undefined} onChange={setValue} disabled={disabled}>
          {({ open }) => (
            <>
              <ListboxButton
                ref={buttonRef}
