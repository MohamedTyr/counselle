// Vendored from upstream client/src/components/Nav/SettingsTabs/DangerButton.tsx @ 197a1dc4
// Verbatim (no subtractions). Kept as the shared destructive-row primitive the
//   plan calls for; no kept tab passes `infoDescriptionCode`.
