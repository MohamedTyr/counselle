...
| [`quick-think-response-mode/`](quick-think-response-mode/) | Quick/Think response modes — `plan/implementation-plan.md`: server-owned counselor mode routing, immutable execution-mode records, sticky chat preference, frontend selector semantics, usage/cost reporting, live/eval rollout gates, and ADR 0034. | Shipped |
