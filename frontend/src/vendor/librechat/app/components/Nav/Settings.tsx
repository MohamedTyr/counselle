// Vendored from upstream client/src/components/Nav/Settings.tsx @ 197a1dc4
// Subtractions: Chat / Commands / Speech / Personalization / Balance / About tabs
//   (+ their icons, usePersonalizationAccess, useGetStartupConfig, the aboutEnabled
//   effect) — MVP2 ships exactly three tabs: General, Data, Account (upstream order).
