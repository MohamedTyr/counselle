// Vendored from upstream client/src/components/Conversations/Conversations.tsx @ 197a1dc4
...
const Conversations: FC<ConversationsProps> = ({
    ...
    () =>
      new CellMeasurerCache({
        ...
        keyMapper: (index) => {
          ...
          // 'favorites' type stripped in MVP2 — never in items
          if (item.type === 'header') {
  ...
  }, [rawConversations, cache, containerRef]);
  ...
  const rowRenderer = useCallback(
    ({ index, key, parent, style }) => {
      ...
      // 'favorites' type stripped in MVP2 — never reaches here
