// Vendored from upstream client/src/components/Auth/RequestPasswordReset.tsx @ 197a1dc4
// Subtractions: useRequestPasswordResetMutation + the emailEnabled inline-link
//   success branch (no email system — mock always shows the "link sent" state).
// Rewire: submit → set the upstream success body text directly.
...
function RequestPasswordReset() {
  ...
  const onSubmit = (_data: TRequestPasswordReset) => {
