    ...
    <SelectPrimitive.Portal {...portalProps}>
      ...
      >
        <SelectPrimitive.Popup
          className="origin-(--transform-origin) text-[var(--workspace-dropdown-foreground)] outline-none"
...
export function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        "grid min-h-8 cursor-default grid-cols-[1rem_1fr] items-center gap-2 rounded-sm py-1 ps-2 pe-4 text-base outline-none in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.25rem)] data-disabled:pointer-events-none data-highlighted:bg-[var(--workspace-dropdown-hover)] data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4",
        className,
      )}
