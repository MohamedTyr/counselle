...
export function Card({
  ...
  const defaultProps = {
    className: cn(
      "relative flex flex-col rounded-2xl border bg-card text-card-foreground shadow-xs/5 bg-clip-padding before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-2xl)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)]",
      className,
    ),
    "data-slot": "card",
  };
