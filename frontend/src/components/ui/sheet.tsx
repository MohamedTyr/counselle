...
export function SheetBackdrop({
  ...
  return (
    <SheetPrimitive.Backdrop
      className={cn(
        "fixed inset-0 z-[var(--z-modal-backdrop)] bg-[var(--overlay-scrim)] backdrop-blur-sm transition-all duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
...
export function SheetFooter({
  ...
  const defaultProps = {
    className: cn(
      ...
      variant === "default" && "border-t bg-[var(--control-track)] py-4",
      variant === "bare" &&
