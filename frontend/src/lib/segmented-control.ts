/*
 * @coss/segmented-control — the registry ships this as a class recipe
 * rather than a component, because a segmented control is a radio group
 * (or a nav, or a toggle group) wearing a particular skin. The component
 * that wears it lives in components/ui/segmented-control.tsx.
 *
 * Verbatim from the registry apart from the import path.
 */
...
export const segmentedControlItemVariants = cva(
  [
    "relative inline-flex shrink-0 cursor-pointer items-center justify-center rounded-md border border-transparent whitespace-nowrap text-base font-medium text-muted-foreground/72 outline-2 outline-transparent transition-[outline-color] select-none hover:bg-transparent hover:text-muted-foreground focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-64 data-disabled:pointer-events-none data-disabled:opacity-64 sm:text-sm",
