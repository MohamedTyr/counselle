...
describe("counseling mode helpers", () => {
  it("accepts only declared counseling mode names", () => {
    expect(isCounselingModeSkillName("focused-answer")).toBe(true);
    expect(isCounselingModeSkillName("constructor")).toBe(false);
  });
